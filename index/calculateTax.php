...
<body>
  <!-- Nav bar -->
  <nav class="navbar">
    <a style="display: flex; justify-content: flex-end; align-items: start;" class="logo" href="./home-page.php"><img
        src="../img/New logo.png" style="width: 40px; margin-right: 12px;">TAXIFY</a>
    <div class="menu">
      <ul>
        <li><a href="./home-page.php#home-section">HOME</a></li>
        <li><a href="./home-page.php#services-section">SERVICES</a></li>
        <li><a href="./home-page.php#about-section">ABOUT</a></li>
        <li><a href="./home-page.php#contact-section">CONTACT</a></li>
    ...
    <div class="info-user">
      ...
      <div class="drop-down">
        <div class="drop-menu">
          <ul>
            <li><a href="./home-page.php"><i class="ri-home-2-fill"></i>HOME</a></li>
            <li></i><a href="./home-page.php#services-section"><i class="ri-gallery-view-2"></i>SERVICES</a></li>
            <li><a href="./home-page.php#about-section"><i class="ri-group-line"></i>ABOUT</a></li>
            <li><a href="./home-page.php#contact-section"><i class="ri-customer-service-2-fill"></i>CONTACT</a></li>
            <li><a href="document.html"><i class="ri-file-copy-2-line"></i>DOCS</a></li>
            <li><a href="./login.php"><i class="ri-logout-box-line"></i>LOGIN</a></li>
          </ul>
        </div>
      </div>
