    ...
    <nav class="navbar navbar-expand-lg px-3 fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="../index/home-page.php#home-section">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../index/home-page.php#services-section">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../index/home-page.php#about-section">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../index/home-page.php#contact-section">Contact Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./document.php">Docs</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="offcanvas offcanvas-end text-bg-dark d-lg-none" tabindex="-1" id="offcanvasDarkNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-center flex-grow-1 ">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="../index/home-page.php#home-section"><i
                                        class="ri-home-2-line"></i>Home</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" aria-current="page" href="../index/home-page.php#services-section"><i
                                        class="ri-apps-2-ai-fill"></i>Services</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="../index/home-page.php#about-section"><i class="ri-team-fill"></i>About</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="./document.php"><i class="ri-file-copy-2-line"></i>Docs</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="../index/home-page.php#contact-section"><i
                        ...
                        <ul class="navbar-nav justify-content-center flex-grow-1">
                            <li class="bav-item pt-4 pb-4">
                                <a class="nav-link" href="./login.php"><i class="ri-logout-box-line"></i>login / register</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h1 style="animation: fade-bot-top 4s ease ;">Hello!</h1>
                        <h6 style="animation: fade-bot-top 4s ease ;">"Welcome to the easy tax calculation website. Get
                            ...
                            <a href="./calculateTax.php" class="btn btn-primary mt-3">Let's strat</a>
                    </div>
                </div>
                <!-- ภาพที่2 -->
